...
pub mod NFT {
    ...
    mod Errors {
        pub const UNAUTHORIZED_CALLER: felt252 = 'ERC721: Unauthorized caller';
    }
    ...
    impl ExternalImpl of ExternalTrait {
        ...
        fn safe_mint(
            ...
            // assert(caller == factory, Errors::UNAUTHORIZED_CALLER);
            self.erc721._safe_mint(caller, token_id, data);
        }
    }
}
